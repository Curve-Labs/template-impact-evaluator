...
export function impactEvaluatorFunction(
  ...
  // add your Impact Evaluator logic here
  // ...
  // ...
  // ...
  ...
  // should return atleast following properties
  // 1) newRewards
  // 2) newTrustedSeed
  // note: if return object doesn't have above properties, the execution will fail
